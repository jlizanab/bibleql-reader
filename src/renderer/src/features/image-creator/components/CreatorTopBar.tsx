...
// A slim copy of TitleBar's frameless-window handling (drag region +
// overlay inset), not a reuse of TitleBar itself — that component is
...
export function CreatorTopBar({ locale, project, onChangeCanvas }: CreatorTopBarProps): JSX.Element {
  ...
  return (
    <div className={styles.bar}>
      ...
      <div className={styles.right} style={isMac ? undefined : { marginRight: overlayInset }}>
